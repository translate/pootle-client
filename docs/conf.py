...
extensions = ['pootle_docs', 'sphinx.ext.autodoc', 'sphinx.ext.intersphinx',
...
project = u'ptl-client'
copyright = u'2013, Translate.org.za'
...
htmlhelp_basename = 'ptl-clientdoc'
...
latex_documents = [
  ('index', 'ptl-client.tex', u'ptl-client Documentation',
...
man_pages = [
    ('index', 'ptl-client', u'ptl-client Documentation',
...
texinfo_documents = [
  ('index', 'ptl-client', u'ptl-client Documentation',
   u'Translate.org.za', 'ptl-client', 'One line description of project.',
   'Miscellaneous'),
]
...
intersphinx_mapping = {
    ...
    'py3k': ('http://docs.python.org/3.3', None),
    'pytest': ('http://pytest.org/latest/', None),
    'django': ('http://django.readthedocs.org/en/latest/', None),
    'pootle': ('http://docs.translatehouse.org/projects/pootle/en/latest/',
               None),
    'virtaal': ('http://docs.translatehouse.org/projects/virtaal/en/latest/',
                None),
    'guide':
